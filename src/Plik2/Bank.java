...
public class Bank {
    public static void main(String[] args) {
        ...
        System.out.print("Podaj liczbę czeków sytawionych w tym miesiącu: ");
        ...
        double CalkowitaOplata = opłataPodstawowa + opłataDodatkowa;
        System.out.println("Całkowita opłata za obsługę czeków: " + CalkowitaOplata + " zł.");
    }
}
